 ...
 * @param {templateFunction} [template] A function used to create a template
...
_.extend(Pill.prototype, /** @lends Pill.prototype */ {
   ...
   * is available.
   * @private
   * @param  {templateFunction} [template] Create an HTML template
  ...
  _createElement: function (template, remove) {
    ...
    if (_.isFunction(template)) {
       ...
       * @param {Object} data.value The template function is called with an
