 ...
 * @param {String} options.key A string used to identify a pill
 * @param {String} options.value A string that will represent this pill in the DOM
 * @param {Boolean} [options.remove] Determines if a pill should have a close button
 *                           if no template is given.
 * @param {Pill~templateFunction} [options.template] A function used to create a template
 * @param {String[]} [options.states] Array of strings to be used as initial states
 */
...
Pill.prototype = _.create(EventEmitter.prototype, /** @lends Pill.prototype */ {
  /**
  ...
  removeState: function (state) {
    ...
    /**
     * Fire an event when a pill's state has been removed
     * @event Pill#state:remove
     */
    this.emit("state:remove", {state: state});
  },
